...
import Question from './QuestionQ';
    ...
    return (
      <View style={styles.container}>
        <ScrollView>
          ...
          >
            <Question data={data1} updateState={this.updateState} />
            <Question data={data2} updateState={this.updateState} />
            <Question data={data3} updateState={this.updateState} />
